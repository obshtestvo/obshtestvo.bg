...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.bio'
        db.alter_column(u'projects_user', 'bio', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'User.avatar'
        db.alter_column(u'projects_user', 'avatar', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'User.bio'
        db.alter_column(u'projects_user', 'bio', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'User.avatar'
        db.alter_column(u'projects_user', 'avatar', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
